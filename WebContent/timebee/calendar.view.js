sap.ui.jsview("timebee.calendar", {
	...
	createContent : function(oController) {
		...
		var dialog = new sap.m.Dialog("dialog",
				{
					...
					content : [
							...
							new sap.m.TimePicker("fromFormEvt")
									.addStyleClass("timeForm"),
							new sap.m.Label({
								text : "To",
								required : true
							}),
							new sap.m.TimePicker("toFormEvt")
									.addStyleClass("timeForm"),
							new sap.m.Label({
								text : "Reccurence",
								required : true
							...
							}), new sap.m.Input("idFormEvt"), new sap.m.Label({
								text : "Description",
		...
		var dialog2 = new sap.m.Dialog("dialogSet", {
			...
			}).addStyleClass("timeForm"), new sap.m.Label({
				text : "Reccurence",
				required : true
		...
		var oPage = new sap.m.Page({
			...
			content : [ new sap.m.Label({
				text : " Welcome, "
			}).addStyleClass("styleWelcome"), oLabel, buttonBox, oCalendar,
					legend, spliter
